...
<head>
    ...
    <title>Register — Paluwagan Tracking</title>
...
<body class="font-sans antialiased min-h-screen relative flex items-center justify-center p-4" style="font-family: 'Outfit', sans-serif;">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8 relative z-10">
            ...
            <p class="text-sm text-pink-700/80 mt-1 font-medium">Create your admin account to get started</p>
        </div>

        <!-- Card -->
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-pink-200/40 border border-white/50 p-8 relative z-10">
            <h2 class="text-xl font-bold text-gray-800 mb-6">Create an account</h2>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <!-- Password -->
                <div>
                    <label for="password" class="block text-sm font-semibold text-gray-700 mb-1.5">Password <span class="text-pink-400 font-normal">(min 8 characters)</span></label>
        ...
        <p class="mt-6 text-center text-sm text-gray-600 font-medium relative z-10">
            ...
            <a href="{{ route('login') }}" class="font-bold text-pink-600 hover:text-pink-700 transition-colors">Sign in</a>
        </p>
    </div>
